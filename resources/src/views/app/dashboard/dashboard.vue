  ...
  <div class="main-content">
    ...
    <!--      <section
          ...
          <b-col md="3" sm="6" class="mb-3 mb-md-0">
            <router-link to="/app/sales/list" class="stat-card sales-card h-100">
              ...
              <div class="stat-card-content">
                <p class="stat-card-label">Total {{ $t('Sales') }}</p>
       ...
       <!--   <b-col md="3" sm="6" class="mb-3 mb-md-0">
          ...
          <b-col v-if="currentUser && (currentUser.role_id === 1 || (currentUserPermissions && currentUserPermissions.includes('money_taken_view')))" md="3" sm="6" class="mb-3 mb-md-0">
            <router-link to="/app/sales/list" class="stat-card sales-due-card h-100">
              <div class="stat-card-icon"><lucide-icon name="banknote" /></div>
              <div class="stat-card-content">
                <p class="stat-card-label">Total {{ $t('Sales_Due') }}</p>
        ...
        <b-row v-else-if="sectionId === 'stat_cards_2'" :key="sectionId" class="mb-3 align-items-stretch dashboard-mobile-stat-grid">
          ...
          <b-col v-if="currentUser && (currentUser.role_id === 1 || (currentUserPermissions && currentUserPermissions.includes('money_taken_view')))" md="3" sm="6" class="mb-3 mb-md-0">
            <router-link to="/app/sales/money-taken" class="stat-card purchases-card h-100">
              <div class="stat-card-icon"><lucide-icon name="banknote" /></div>
              <div class="stat-card-content">
                <p class="stat-card-label">Total Collected from Shop</p>
                <h3 class="stat-card-value">{{ formatPriceWithSymbol(currentUser && currentUser.currency, report_today.total_taken || 0, 2) }}</h3>
              </div>
            </router-link>
          </b-col>
          <b-col v-if="currentUserPermissions && currentUserPermissions.includes('money_taken_view')" md="3" sm="6" class="mb-3 mb-md-0">
            <router-link to="/app/sales/money-taken" class="stat-card purchase-due-card h-100">
              <div class="stat-card-icon"><lucide-icon name="wallet" /></div>
              <div class="stat-card-content">
                <p class="stat-card-label">Total Amount Remaining to be Collected from Shop</p>
                <h3 class="stat-card-value">{{ formatPriceWithSymbol(currentUser && currentUser.currency, report_today.taken_remaining || 0, 2) }}</h3>
              </div>
            </router-link>
          </b-col>  
        <!--  <b-col md="3" sm="6" class="mb-3 mb-md-0">
      ...
      axios
        ...
        .then(response => {
          ...
          this.report_today = {
            ...
            total_taken: Number(reportData.total_taken) || 0,
            taken_remaining: Number(reportData.taken_remaining) || 0,
          };
