...
const biNames = [
'droplet', 'droplet-fill', 'droplet-half',      // washing / water
  'wind',                                          // drying / air dry
  'brightness-high',                               // sun-dry
  'thermometer-half',                              // water/heat temperature
  'basket', 'basket2', 'basket2-fill', 'basket3',  // laundry basket
  'bag', 'bag-fill', 'bag-check',                  // dry cleaning bag / order ready
  'stars',                                         // fresh/clean/quality
  'scissors',                                      // tailoring / alterations
  'iron',                                          // ironing (yes, bi-iron exists!)
  'recycle',                                       // eco-friendly wash
  'shield-check',                                  // fabric care / guarantee
  'truck', 'truck-flatbed',                        // pickup & delivery
  'house-door',                                    // home pickup
  'clock', 'stopwatch', 'hourglass-split',         // turnaround time / express service
  'gear', 'sliders' 
]
