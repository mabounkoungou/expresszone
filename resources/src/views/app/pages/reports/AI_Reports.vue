      ...
      <b-card class="header-card shadow-soft border-0">
        <div class="d-flex align-items-center">
          ...
          <div class="flex-grow-1">
            <h4 class="mb-1 font-weight-bold text-white">AI Business Insights</h4>
          ...
          <b-card class="mb-4 shadow-soft border-0 report-actions-card">
            <div class="d-flex align-items-center justify-content-between flex-wrap">
              ...
              <div class="report-actions">
                <b-button v-if="canExport" variant="outline-primary" size="sm" class="mr-2" @click="exportToPDF('daily_sales')">
                  <lucide-icon class="mr-1" name="file-text" /> PDF
                </b-button>
                <b-button v-if="canExport" variant="outline-success" size="sm" class="mr-2" @click="exportToExcel('daily_sales')">
                  <lucide-icon class="mr-1" name="file-spreadsheet" /> Excel
                </b-button>
                <b-button v-if="canExport" variant="outline-secondary" size="sm" @click="printReport('daily_sales')">
        ...
        <div v-else-if="reportResult.question.report_key === 'sales_by_product'" class="report-content fade-up">
          ...
          <b-card class="mb-4 shadow-soft border-0 report-actions-card">
            <div class="d-flex align-items-center justify-content-between flex-wrap">
              ...
              <div class="report-actions">
                <b-button v-if="canExport" variant="outline-primary" size="sm" class="mr-2" @click="exportToPDF('products')">
                  <lucide-icon class="mr-1" name="file-text" /> PDF
                </b-button>
                <b-button v-if="canExport" variant="outline-success" size="sm" class="mr-2" @click="exportToExcel('products')">
                  <lucide-icon class="mr-1" name="file-spreadsheet" /> Excel
                </b-button>
                <b-button v-if="canExport" variant="outline-secondary" size="sm" @click="printReport('products')">
                  <lucide-icon class="mr-1" name="printer" /> Print
                </b-button>
              </div>
            </div>
        ...
        <div v-else-if="reportResult.question.report_key === 'late_payments'" class="report-content fade-up">
          ...
          <b-card class="mb-4 shadow-soft border-0 report-actions-card">
            <div class="d-flex align-items-center justify-content-between flex-wrap">
              ...
              <div class="report-actions">
                <b-button v-if="canExport" variant="outline-primary" size="sm" class="mr-2" @click="exportToPDF('late_payments')">
                  <lucide-icon class="mr-1" name="file-text" /> PDF
                </b-button>
                <b-button v-if="canExport" variant="outline-success" size="sm" class="mr-2" @click="exportToExcel('late_payments')">
                  <lucide-icon class="mr-1" name="file-spreadsheet" /> Excel
                </b-button>
                <b-button v-if="canExport" variant="outline-secondary" size="sm" @click="printReport('late_payments')">
                  <lucide-icon class="mr-1" name="printer" /> Print
                </b-button>
              </div>
            </div>
...
export default {
  ...
  computed: {
    ...
    canExport() {
      return this.currentUser && (this.currentUser.role_id === 1 || (this.currentUserPermissions && this.currentUserPermissions.includes('business_insights_export')));
    },
    canRun() {
      return this.currentUser && (this.currentUser.role_id === 1 || (this.currentUserPermissions && this.currentUserPermissions.includes('business_insights_run')));
    },
    currency() {
