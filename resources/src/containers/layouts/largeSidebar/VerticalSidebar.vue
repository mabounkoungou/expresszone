    ...
    >
      ...
      <nav class="vertical-nav-menu">
        ...
        <!--      <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('product_import')">
          ...
          >
            ...
            <ul class="submenu" v-if="openMenus.includes('sales') && !isCollapsed">
              ...
              <li class="submenu-item" v-if="currentUser && (Number(currentUser.role_id) === 1 || (currentUserPermissions && currentUserPermissions.includes('Sales_view'))) ">
              ...
              <li class="submenu-item" v-if="currentUserPermissions && currentUserPermissions.includes('Sales_view')">
                <router-link to="/app/sales/money-taken" class="submenu-link">
                  <lucide-icon class="submenu-icon" name="wallet" />
       ...
       Service & Maintenance 
          ...
          <!-- AI Reports -->
          <li
            v-show="currentUser && (Number(currentUser.role_id) === 1 || (currentUserPermissions && (currentUserPermissions.includes('AI_Reports') || currentUserPermissions.includes('business_insights_view'))))"
          ...
          >
            <router-link to="/app/reports/ai_reports" class="nav-link">
              ...
              <span class="nav-text" v-if="!isCollapsed">AI Reports</span>
            </router-link>
          </li>

          <li
            v-show="currentUser && (Number(currentUser.role_id) === 1 || (currentUserPermissions && currentUserPermissions.includes('business_insights_view')))"
            :class="{ active: isActiveRoute('business_insights') }"
            class="nav-item"
          >
            <router-link to="/app/reports/business_insights" class="nav-link">
              <lucide-icon class="nav-icon" name="brain" />
              <span class="nav-text" v-if="!isCollapsed">AI Business Insights</span>
            </router-link>
          </li>
