...
const baseRoutes = [
    {
        ...
        children: [
            ...
            {
                path: "/app/sales/money-taken",
                name: "money_taken",
                component: () =>
                    import(
                        /* webpackChunkName: "money_taken" */ "./views/app/pages/sales/money_taken"
                    ),
            },
            ...
            //Products
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import(
                                /* webpackChunkName: "import_products_update" */ "./views/app/pages/products/Import_products_update.vue"
                            ),
                    },
                    {
                        path: "store",
                ...
                children: [
                    {
                        ...
                        path: "list",
                        component: () =>
                            import("./views/app/pages/quotations/index_quotation"),
                    },
                    {
            ...
            // Reports
            {
                ...
                children: [
...

                    {
                        ...
                        component: () =>
                            import("./views/app/pages/reports/Stock_Adjustment_Report"),
                    },
...

                    {
                        ...
                        component: () => import("./views/app/pages/reports/Business_Insights"),
                    },
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import(
                                /* webpackChunkName: "warranty_guarantee_report" */ "./views/app/pages/reports/Warranty_Guarantee_Report"
                            ),
                    },
                    {
