 ...
 * @method static BasePDF setPdfA(bool $enabled = true)
 * @method static BasePDF addEmbeddedFile(string $filePath, string $name, string $description = '', string $mimeType = 'text/xml')
 * @method static BasePDF setAdditionalXmpRdf(string $xmpRdf)
