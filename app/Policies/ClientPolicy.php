...
class ClientPolicy
{
    ...
    public function business_insights_view(User $user)
    {
        return $this->hasPermissionOrLegacy($user, 'business_insights_view');
    }

    public function business_insights_run(User $user)
    {
        return $this->hasPermissionOrLegacy($user, 'business_insights_run');
    }

    public function business_insights_export(User $user)
    {
        return $this->hasPermissionOrLegacy($user, 'business_insights_export');
    }

    protected function hasPermissionOrLegacy(User $user, string $permissionName): bool
    {
        ...
        $legacy = Permission::where('name', 'AI_Reports')->first();
        return $legacy ? $user->hasRole($legacy->roles) : false;
    }
