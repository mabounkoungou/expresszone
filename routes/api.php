...
Route::middleware(['auth:api', 'Is_Active', 'request.safety', 'token.timeout'])->group(function () {
    ...
    Route::get('business-insights', 'ReportQuestionController@businessInsights');
    ...
    Route::get('money-taken', 'MoneyTakenController@index');
    Route::post('money-taken', 'MoneyTakenController@store');
